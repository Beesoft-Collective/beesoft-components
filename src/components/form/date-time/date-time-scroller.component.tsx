...
const DateTimeScroller = ({
  ...
  const buttonStyles = 'bsc:bg-transparent bsc:focus:outline-hidden bsc:hover:bg-primary-1 bsc:hover:text-white bsc:dark:hover:bg-mono-light-1 bsc:dark:hover:text-mono-dark-1';
