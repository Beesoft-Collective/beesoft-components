...
const CheckboxComponent = (props: CheckboxProps, ref: Ref<CheckboxRef>) => {
  ...
  console.log('name', name, 'checked property', JSON.stringify(checkedProperty));
  console.log('name', name, 'partial property', JSON.stringify(partialProperty));
  const id = useId();
  ...
  useEffect(() => {
    console.log('name', name, 'useEffect checked state', JSON.stringify(checkedState));
    if (checkedState.initial) {
      ...
      console.log('name', name, 'useEffect checked property', JSON.stringify(checkedProperty));
      console.log('name', name, 'useEffect partial property', JSON.stringify(partialProperty));
      ...
      console.log('name', name, 'new partial', newPartial);
      setCheckedState({
  ...
  console.log('name', name, 'checked state', JSON.stringify(checkedState));
  return (
